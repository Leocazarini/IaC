...
**Fase atual:** 1.3 — 🟨 em andamento, na branch `feat/c1f3-cripto-auditoria`
**Próxima ação concreta:** código escrito e validação estática limpa. Falta
aplicar no lab e rodar o checklist da fase — o `apply` exige a credencial com
MFA, que só o operador resolve. A branch da 1.3 sai da branch da 1.2, que ainda
não foi mergeada: o PR da 1.2 entra primeiro, e até lá o PR da 1.3 tem
`feat/c1f2-vpc-rede` como base. Ver
